...
export function DoctorCardGrid({
  ...
  return (
    <Card className="group relative overflow-hidden border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl bg-card/95 backdrop-blur-sm h-full flex flex-col pt-0 gap-0">
      ...
      <Link
        href={`/booking/${id}`}
        className="relative w-full h-64 bg-linear-to-br from-primary via-primary/80 to-accent overflow-hidden block"
      >
        {image ? (
          <>
            <Image
        ...
        {/* Verified Badge */}
        <div className="absolute top-4 right-4 w-12 h-12 bg-linear-to-br from-green-500 to-green-600 rounded-full flex items-center justify-center border-4 border-card shadow-xl ring-2 ring-green-200/50">
      ...
      <div className="relative p-6 flex-1 flex flex-col">
        ...
        <Button
          ...
          className="w-full bg-linear-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary text-primary-foreground gap-2 group-hover:shadow-xl transition-all duration-300 cursor-pointer relative z-10 font-semibold h-12 overflow-hidden"
