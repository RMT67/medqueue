...
export async function POST(req: Request) {
  ...
  fetch("http://127.0.0.1:7242/ingest/cf3da9b3-e361-40d2-9804-0e59c14855ca", {
    ...
    body: JSON.stringify({
      location: "api/auth/login/route.ts:21",
      message: "POST handler entry",
      data: { hasJwtSecret: !!JWT_SECRET },
      timestamp: Date.now(),
  ...
  try {
    ...
    fetch("http://127.0.0.1:7242/ingest/cf3da9b3-e361-40d2-9804-0e59c14855ca", {
      ...
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
        location: "api/auth/login/route.ts:23",
        message: "before connectDB",
        data: {},
        timestamp: Date.now(),
        sessionId: "debug-session",
        runId: "run1",
    ...
    fetch("http://127.0.0.1:7242/ingest/cf3da9b3-e361-40d2-9804-0e59c14855ca", {
      ...
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
        location: "api/auth/login/route.ts:25",
        message: "after connectDB",
        data: {},
        timestamp: Date.now(),
        sessionId: "debug-session",
        runId: "run1",
    ...
    fetch("http://127.0.0.1:7242/ingest/cf3da9b3-e361-40d2-9804-0e59c14855ca", {
      ...
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
        location: "api/auth/login/route.ts:28",
        message: "request body parsed",
        data: { hasEmail: !!email, hasPassword: !!password, role },
        timestamp: Date.now(),
        sessionId: "debug-session",
        runId: "run1",
        hypothesisId: "B",
    ...
    fetch("http://127.0.0.1:7242/ingest/cf3da9b3-e361-40d2-9804-0e59c14855ca", {
      ...
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
        location: "api/auth/login/route.ts:66",
    ...
    fetch("http://127.0.0.1:7242/ingest/cf3da9b3-e361-40d2-9804-0e59c14855ca", {
      ...
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
        location: "api/auth/login/route.ts:78",
    ...
    fetch("http://127.0.0.1:7242/ingest/cf3da9b3-e361-40d2-9804-0e59c14855ca", {
      ...
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
        location: "api/auth/login/route.ts:87",
        message: "returning error response",
        data: { userMessage, errorMessage },
        timestamp: Date.now(),
        sessionId: "debug-session",
        runId: "run1",
        hypothesisId: "B",
