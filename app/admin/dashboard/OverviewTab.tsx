    ...
    <div className="space-y-8">
      ...
      <div>
        <div className="flex items-center gap-3 mb-6">
          <div className="w-10 h-10 rounded-xl bg-liniaer-to-br from-primary to-accent flex items-center justify-center shadow-md">
            <Users className="w-5 h-5 text-white" />
          </div>
        ...
        {doctors.filter((doctor) => doctor.status === "online").length === 0 ? (
                      ...
                      <div className="relative w-20 h-20 rounded-2xl overflow-hidden border-2 border-primary/20 shrink-0 shadow-md">
                        {doctor.image ? (
                          <>
                            ...
                            />
                            <div className="image-fallback hidden w-full h-full absolute inset-0 items-center justify-center bg-liniaer-to-br from-primary to-accent text-white font-bold text-xl">
                              {initials}
                            </div>
                          </>
                        ) : (
                          <div className="w-full h-full flex items-center justify-center bg-liniaer-to-br from-primary to-accent text-white font-bold text-xl">
                            {initials}
                          </div>
                        )}
                      </div>
